    ...
    <el-row>
      ...
      <el-table
              ...
              <template slot-scope="props">
                  <el-form label-position="left" inline class="demo-table-expand">
                      ...
                      <el-form-item label="订单状态:">
                          <span>{{ Stuate(props.row.OrderStatus) }}</span>
                      </el-form-item><br>
          ...
          <el-table-column
              ...
              width="200px">
              <template slot-scope="scope">
                  <span style="margin-left: 10px">{{Stuate(scope.row.OrderStatus)}}</span>
              </template>
          </el-table-column>
          <el-table-column
              label="操作"
    ...
    methods:{
        ...
        handleEdit(index,row){
            if (row.OrderStatus===0){
                row.OrderStatus=1
                axios({
                    url:'http://localhost:8080/demo/api/OrderMange/UpdateOrder',
                    method:"post",
                    data:{
                        OrderStatus:1,
                        OrderID:row.OrderID
